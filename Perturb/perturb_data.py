...
class PerturbPix:
    ...
    def __init__(self,pixels,rot_mats,image_size,block_size,action='rot+pert',noise_expansion=1.0):
...
def main():
    ...
    for pixels in np_data:
        print pixels
        rotated_pixel=PerturbPix(pixels,rot_mats,image_size,block_size,'rot+pert',100.0)
